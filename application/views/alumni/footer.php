        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <aside class="logo">
                        <img style="max-width: 180px; margin-top:20%;" ; src="<?php echo base_url(); ?>uploads/logos/<?php echo $this->db->get_where('setting', array('setting_id' => 6))->row()->content; ?>" class="vertical-center">
                    </aside>
                </div><!-- /.col-md-3 -->
                ...
                <div class="col-md-3 col-sm-4">
                    <aside>
                        <header>
                            <h4><?php echo $this->lang->line('important_links'); ?></h4>
                        </header>
                        <ul class="list-links">
                ...
                <div class="col-md-3 col-sm-4">
                    <aside>
                        <header>
                            <h4><?php echo $this->lang->line('about'); ?> <?php echo $this->db->get_where('about_us', array('about_us_id' => '1'))->row()->title; ?></h4>
                        </header>
        ...
        <div class="container">
            <div class="footer-inner">
                <div class="copyright" align="center">
                    ...
                    <br>
                    &copy; 2022 - <?php echo date('Y'); ?> <a href="<?php echo $this->db->get_where('setting', array('setting_id' => 9))->row()->content; ?>" target="_blank"><?php echo $this->db->get_where('setting', array('setting_id' => 3))->row()->content;; ?></a>, All rights reserved.
                </div>
            </div>
        </div>
    </section>
